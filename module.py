...
def generator_a2b(image, options, reuse=False, name="generatorB"):
    ...
    with tf.variable_scope(name):
        ...
        e4 = instance_norm(conv2d(lrelu(r3), options.gf_dim*8, name='g_e4_conv'), 'g_bn_e4')
        ...
        r5 = residule_block(r4, options.gf_dim*4, name='gab_r4')
        r6 = residule_block(r5, options.gf_dim*4, name='gab_r4')
        r7 = residule_block(r6, options.gf_dim*4, name='gab_r4')
        r8 = residule_block(r7, options.gf_dim*4, name='gab_r4')
        r9 = residule_block(r8, options.gf_dim*4, name='gab_r4')
        # (4,4, dim*4)
        ...
        # (5 x 5 x 64)
        d3 = conv2d(d2, 2, ks=2,s=1, name='g_pred')
        # (5 x 5 x 2)
        return d3
