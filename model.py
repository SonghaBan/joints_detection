...
class cyclegan(object):
    ...
    def train(self, args):
        ...
        for epoch in range(args.epoch):
            ...
            dataB = np.loadtxt('./datasets/{}/joints2D.csv'.format(self.dataset_dir + '/trainB'),dtype=np.float32)
    ...
    def test(self, args):
        ...
        if args.which_direction == 'AtoB':
            ...
            status = 1
            sample_files = np.loadtxt('./datasets/{}/joints2D.csv'.format(self.dataset_dir + '/testB'),dtype=np.float32)
        else:
